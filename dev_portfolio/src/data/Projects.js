export const projects = [
    ...
    },
    {
        ...
        detailedDescription: "My role at DFM Technologies covers a vast majority of IT Roles, it can range from Software support to a Database Administrator all depending on the needs of the day. I currently work as an IT Technician; however, I work also as a Database administrator, IT Software Support and Software Developer.\n As part of my role in IT Support, I address a wide range of technical issues to ensure minimal disruption to business operations. I provide remote and on-site support for software, hardware, and network-related problems. I have assisted in the installation, configuration, and updates of business-critical applications, ensuring compatibility across different operating systems and user environments. I maintain clear and professional communication with clients to understand their technical challenges.\n Beyond my primary IT support duties, I take on significant responsibilities as a Database Administrator (DBA), ensuring data integrity, security, and optimal performance across the organization’s databases. I perform routine checks, index rebuilds, and query optimizations to enhance database performance. I also monitor resource usage to prevent bottlenecks and ensure smooth operations; and I identify and resolve data inconsistencies caused by user errors. I have had to review and rewrite outdated stored procedures to improve efficiency and align with current business logic. My dual expertise in IT Support and Database Administration allows me to bridge the gap between end-user needs and backend system stability, ensuring seamless operations across the organization.\n Upon my arrival at the company, the current Android mobile application had been removed from Google Play store for not adhering to the new google standards. I initially attempted to just upload a newer version of the application, however, due to some outdated plugins the application was not portable to a newer Gradle version. Because I had prior knowledge of mobile application development and APIs, I then took it upon myself to rewrite the mobile application, it was easy to implement the retrofit framework and have communication between the mobile application and the API service. While developing, I took the initiative to implement some long overdue features requested by customers, such as: block and probe sorting, as well as, light and dark mode.\n My key achievements at DFM Technologies is: the rewrite of the mobile application and the migration of the SAP server.", 
        // working for a company that deals with Continuous Logging Probes, a lot of storage is required to store the data gathered from these probes. It is my job to load these probes on the existing Database, link these probes to the clients and using scripts and stored procedures, I have to ensure that the information being shown to the client is accurate.
        tags: ["JavaScript", "Android Development", "Responsive Design"],
        technologies: ["Android Development", "Swift", "RealmDB"],
        techStack: ["C#", "GitHub", "Postman", "ASP.Net", "Android Development", "MySQL", "C#"],
        link: "#"
    },
    {
        ...
        detailedDescription: "This project is still in development...", //TODO Add more information here
